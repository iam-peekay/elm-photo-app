		...
		switch (_p2.ctor) {
			...
			case 'SurpriseMe':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_elm_lang$core$Random$generate, _user$project$PhotoApp$SelectByIndex, _user$project$PhotoApp$randomPhotoPicker)
				};
			case 'SetSize':
				return {
					ctor: '_Tuple2',
...
var _user$project$PhotoApp$main = _elm_lang$html$Html$program(
	{
		init: {ctor: '_Tuple2', _0: _user$project$PhotoApp$initialModel, _1: _elm_lang$core$Platform_Cmd$none},
		view: _user$project$PhotoApp$view,
