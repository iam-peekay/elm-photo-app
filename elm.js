...
var _user$project$PhotoApp$Photo = F3(
	function (a, b, c) {
		return {url: a, size: b, title: c};
	});
var _user$project$PhotoApp$photoDecoder = A4(
	...
	A3(
		...
		A3(
			...
			'url',
			_elm_lang$core$Json_Decode$string,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$PhotoApp$Photo))));
var _user$project$PhotoApp$Model = F4(
	function (a, b, c, d) {
		return {photos: a, selectedUrl: b, loadingError: c, chosenSize: d};
	});
var _user$project$PhotoApp$LoadPhotos = function (a) {
	return {ctor: 'LoadPhotos', _0: a};
};
var _user$project$PhotoApp$initialCmd = A2(
	_elm_lang$http$Http$send,
	_user$project$PhotoApp$LoadPhotos,
	A2(
		_elm_lang$http$Http$get,
		'http://elm-in-action.com/photos/list.json',
		_elm_lang$core$Json_Decode$list(_user$project$PhotoApp$photoDecoder)));
		...
		switch (_p2.ctor) {
			...
			case 'SurpriseMe':
				...
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_elm_lang$core$Random$generate, _user$project$PhotoApp$SelectByIndex, randomPhotoPicker)
				};
			case 'SetSize':
				return {
					ctor: '_Tuple2',
...
var _user$project$PhotoApp$SetSize = function (a) {
					...
					_1: {
						...
						_1: {
							...
							_0: _elm_lang$html$Html_Events$onClick(
								_user$project$PhotoApp$SetSize(size)),
							_1: {ctor: '[]'}
						}
					}
				},
...
var _user$project$PhotoApp$SurpriseMe = {ctor: 'SurpriseMe'};
var _user$project$PhotoApp$SelectByUrl = function (a) {
	...
	function (selectedUrl, thumbnail) {
		return A2(
			_elm_lang$html$Html$img,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$src(
					A2(_elm_lang$core$Basics_ops['++'], _user$project$PhotoApp$urlPrefix, thumbnail.url)),
				_1: {
					ctor: '::',
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(
								_user$project$PhotoApp$SelectByUrl(thumbnail.url)),
							_1: {ctor: '[]'}
						}
					}
				}
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Photo App'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$PhotoApp$SurpriseMe),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
...
var _user$project$PhotoApp$viewOnError = function (model) {
	var _p4 = model.loadingError;
	if (_p4.ctor === 'Nothing') {
		return _user$project$PhotoApp$view(model);
	} else {
		return A2(
			_elm_lang$html$Html$div,
			{
...
var _user$project$PhotoApp$main = _elm_lang$html$Html$program(
	{
		init: {ctor: '_Tuple2', _0: _user$project$PhotoApp$initialModel, _1: _user$project$PhotoApp$initialCmd},
		view: _user$project$PhotoApp$viewOnError,
		update: _user$project$PhotoApp$update,
...
if (typeof _user$project$PhotoApp$main !== 'undefined') {
    _user$project$PhotoApp$main(Elm['PhotoApp'], 'PhotoApp', undefined);
}
